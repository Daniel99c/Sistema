...
export default function Welcome() {
    ...
    return (
        <>
            ...
            <div 
                className={`flex min-h-screen flex-col items-center text-[#1b1b18] lg:justify-center ${darkMode ? 'dark' : ''}`}
                style={{
                    background: darkMode ? '#0a0a0a' : 'linear-gradient(135deg, #FDFDFC 0%, #f5f5f3 100%)',
                }}
            >
                <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? 'bg-white/90 backdrop-blur-sm shadow-sm dark:bg-[#0a0a0a]/90' : 'bg-transparent'}`}>
                            ...
                            <div className="flex items-center">
                                ...
                                {auth.user ? (
                                    <Link
                                        ...
                                        className="inline-block rounded-md border border-[#19140035] px-5 py-1.5 text-sm font-medium transition-all hover:bg-[#0057b7] hover:text-white hover:border-[#0057b7] dark:border-[#3E3E3A] dark:text-[#EDEDEC] dark:hover:border-[#2196f3] dark:hover:bg-[#2196f3]"
                                    >
                                        Dashboard
                                    </Link>
                                ) : (
                                    <>
                                        <Link
                                            href={route('login')}
                                            className="inline-block rounded-md border border-transparent px-4 py-1.5 text-sm font-medium transition-all hover:bg-[#f5f5f3] dark:text-white dark:hover:bg-[#161615] mr-2"
                                        >
                                            Iniciar Sesión
                                        </Link>
                                        <Link
                ...
                <div className="flex w-full items-center justify-center opacity-100 transition-opacity duration-750 lg:grow starting:opacity-0 mt-16 px-6">
                    <main className="flex w-full max-w-[335px] flex-col-reverse lg:max-w-4xl lg:flex-row shadow-lg rounded-lg overflow-hidden">
                        <div className="flex-1 bg-white p-5 pb-6 text-[14px] leading-[20px] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] dark:bg-[#161615] dark:text-[#EDEDEC] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d] relative bg-gradient-to-br from-white to-[#f0f8ff] dark:from-[#161615] dark:to-[#0d2548]/70">
                            ...
                            <div className="relative z-10 mt-3 ml-3">
                                ...
                                <h1 className="font-semibold text-3xl lg:text-4xl bg-gradient-to-r from-[#0057b7] to-[#2187e5] bg-clip-text text-transparent dark:from-[#2196f3] dark:to-[#64b5f6] relative z-10">
                                        Programa de Ingeniería<br />de Sistemas UNIMAR
                                    </h1>
                                    <div className="absolute -right-2 -top-2 w-10 h-10 bg-[#e6f3ff]/50 dark:bg-[#0d47a1]/30 rounded-full blur-xl -z-10"></div>
                                </div>
                                <div className="flex items-center mb-4 px-3 py-1.5 bg-[#e6f3ff] dark:bg-[#0d47a1]/30 rounded-md max-w-max">
                                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-[#0057b7] dark:text-[#2196f3] mr-2">
                                ...
                                <p className="text-[#0d47a1] dark:text-[#bbdefb] text-base font-medium">
                                        ¡Egresado estamos contigo!
                                    </p>
                                </div>
                                
                                <div className="bg-[#f0f8ff] dark:bg-[#0d2548]/30 p-3 rounded-lg shadow-sm mb-4 hover:shadow-md transition-all transform hover:-translate-y-0.5 border border-[#d4e6f9] dark:border-[#1a4b91]">
                                    <div className="flex items-start">
                                        <div className="mr-2 flex-shrink-0 mt-1">
                                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M9 12L11 14L15 10M12 3L4 10V20H20V10L12 3Z" stroke="#0057b7" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                                            </svg>
                                        </div>
                                ...
                                {/* Destacados - callout */}
                                <div className="mt-3 mb-4 bg-gradient-to-r from-[#e6f3ff] to-[#f0f8ff] dark:from-[#0d2548]/70 dark:to-[#0d2548]/40 p-2.5 rounded-lg border-l-3 border-[#0057b7] dark:border-[#2196f3] shadow-sm">
                                    <p className="text-sm font-medium text-[#0d47a1] dark:text-[#bbdefb]">
                                ...
                                <div className="my-4 flex flex-wrap gap-3">
                                    <a
                                        ...
                                        target="_blank"
                                        className="group flex items-center gap-2 bg-white dark:bg-[#161615]/60 px-4 py-2 rounded-md border border-[#d4e6f9] dark:border-[#1a4b91] shadow-sm hover:shadow-md transition-all hover:-translate-y-0.5"
                                    >
                                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-[#0057b7] dark:text-[#2196f3]">
                                            <path d="M3 12L5 10M5 10L12 3L19 10M5 10V20C5 20.5523 5.44772 21 6 21H9M19 10L21 12M19 10V20C19 20.5523 18.5523 21 18 21H15M9 21C9.55228 21 10 20.5523 10 20V16C10 15.4477 10.4477 15 11 15H13C13.5523 15 14 15.4477 14 16V20C14 20.5523 14.4477 21 15 21M9 21H15" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                                        </svg>
                                        <span className="font-medium text-sm text-[#0d47a1] dark:text-white">Nuestra universidad</span>
                                    </a>
                                    <a
                                    ...
                                    >
                                        ...
                                        <span className="font-medium text-sm text-[#0d47a1] dark:text-white">Nuestro programa</span>
                                    </a>
                                </div>
                                ...
                                <div className="mt-4 p-4 bg-white dark:bg-[#161615]/70 rounded-lg border border-[#d4e6f9] dark:border-[#1a4b91] shadow-sm hover:shadow-md transition-all">
                                    ...
                                    <div className="grid grid-cols-2 gap-2 text-sm">
                                        <div className="flex flex-col">
                                            <span className="text-[#64748b] dark:text-[#90caf9]">Duración</span>
                                            <span className="font-medium text-[#0d47a1] dark:text-white">9 semestres</span>
                                        </div>
                                        <div className="flex flex-col">
                                            <span className="text-[#64748b] dark:text-[#90caf9]">Modalidad</span>
                                            <span className="font-medium text-[#0d47a1] dark:text-white">Presencial</span>
                                        </div>
                                        <div className="flex flex-col">
                                            <span className="text-[#64748b] dark:text-[#90caf9]">Código SNIES</span>
                                            <span className="font-medium text-[#0d47a1] dark:text-white">1887</span>
                                        </div>
                                        <div className="flex flex-col">
                                            <span className="text-[#64748b] dark:text-[#90caf9]">Título</span>
                                            <span className="font-medium text-[#0d47a1] dark:text-white">Ingeniero de Sistemas</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className="relative w-full shrink-0 overflow-hidden bg-[#fff2f2] lg:w-[438px] dark:bg-[#1D0002] group">
                            ...
                            {/* Badge flotante */}
                            <div className="absolute top-4 right-4 bg-white dark:bg-[#1D0002] text-[#0057b7] dark:text-[#2196f3] px-3 py-1 rounded-md shadow-md z-20 font-medium text-xs">
                                SNIES 1887
                            </div>
                            ...
                            <div className="absolute inset-0 rounded-t-lg shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] lg:rounded-t-none lg:rounded-r-lg dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d] z-10" />
                        </div>
                    </main>
                </div>
